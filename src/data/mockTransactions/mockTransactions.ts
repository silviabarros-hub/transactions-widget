...
export const mockTransactions: Transaction[] = [
  {
    ...
    value: 500,
    unit: "BTC",
    icon: "/transactions-widget/assets/token-icons/bitcoin.svg",
    submitted: true,
  ...
  },
  {
    ...
    value: 250,
    unit: "AVAX",
    icon: "/transactions-widget/assets/token-icons/avalanche.svg",
    submitted: true,
  ...
  },
  {
    ...
    value: 1000,
    unit: "OP",
    icon: "/transactions-widget/assets/token-icons/optimism-2.svg",
    submitted: true,
  ...
  },
  {
    ...
    value: 750,
    unit: "SUI",
    icon: "/transactions-widget/assets/token-icons/sui.svg",
    submitted: true,
    status: TransactionStatus.Approved,
  ...
  },
  {
    ...
    value: 300,
    unit: "STR",
    icon: "/transactions-widget/assets/token-icons/starknet.svg",
    submitted: true,
    status: TransactionStatus.Approved,
